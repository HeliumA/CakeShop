<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="蛋糕表名" prop="tablename">
          <el-input v-model="ruleForm.tablename" 
              placeholder="蛋糕表名" clearable  :readonly="ro.tablename"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="蛋糕表名" prop="tablename">
              <el-input v-model="ruleForm.tablename" 
                placeholder="蛋糕表名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="蛋糕id" prop="goodid">
          <el-input v-model="ruleForm.goodid" 
              placeholder="蛋糕id" clearable  :readonly="ro.goodid"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="蛋糕id" prop="goodid">
              <el-input v-model="ruleForm.goodid" 
                placeholder="蛋糕id" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="蛋糕名称" prop="goodname">
          <el-input v-model="ruleForm.goodname" 
              placeholder="蛋糕名称" clearable  :readonly="ro.goodname"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="蛋糕名称" prop="goodname">
              <el-input v-model="ruleForm.goodname" 
  ...
  data() {
	...
	discountprice : false,
            ...
            ruleForm: {
                  ...
                  goodid: [
                            { required: true, message: '蛋糕id不能为空', trigger: 'blur' },
                                    	                                                              ],
                  goodname: [
                                    	                                                              ],
                  picture: [
