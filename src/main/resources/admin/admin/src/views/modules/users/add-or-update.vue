<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="客户名" prop="username">
          <el-input v-model="ruleForm.username" 
              placeholder="客户名" clearable  :readonly="ro.username"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="客户名" prop="username">
              <el-input v-model="ruleForm.username" 
                placeholder="客户名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
