<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="蛋糕分类" prop="shangpinfenlei">
          <el-input v-model="ruleForm.shangpinfenlei" 
              placeholder="蛋糕分类" clearable  :readonly="ro.shangpinfenlei"></el-input>
        </el-form-item>
        <div v-else>
  ...
  data() {
	...
	shangpinfenlei : false,
            ...
            ruleForm: {
                          ...
                          rules: {
                  shangpinfenlei: [
                            { required: true, message: '蛋糕分类不能为空', trigger: 'blur' },
                                    	                                                              ],
              }
    };
  },
