<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="蛋糕编号" prop="shangpinbianhao">
            <el-input v-model="ruleForm.shangpinbianhao" 
                placeholder="蛋糕编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shangpinbianhao" label="蛋糕编号" prop="shangpinbianhao">
              <el-input v-model="ruleForm.shangpinbianhao" 
                placeholder="蛋糕编号" readonly></el-input>
          </el-form-item>
        </div>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="蛋糕名称" prop="shangpinmingcheng">
          <el-input v-model="ruleForm.shangpinmingcheng" 
              placeholder="蛋糕名称" clearable  :readonly="ro.shangpinmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="蛋糕名称" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng" 
                placeholder="蛋糕名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="蛋糕分类" prop="shangpinfenlei">
          <el-select v-model="ruleForm.shangpinfenlei" placeholder="请选择蛋糕分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="蛋糕分类" prop="shangpinfenlei">
	      <el-input v-model="ruleForm.shangpinfenlei"
                placeholder="蛋糕分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmian" label="封面" prop="fengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fengmian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否特价" prop="shifoutejia">
          <el-select v-model="ruleForm.shifoutejia" placeholder="请选择是否特价">
            <el-option
                v-for="(item,index) in shifoutejiaOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否特价" prop="shifoutejia">
	      <el-input v-model="ruleForm.shifoutejia"
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
            continue;
	            	            ...
	            	            if(o=='shifoutejia'){
            this.ruleForm.shifoutejia = obj[o];
	    this.ro.shifoutejia = true;
            continue;
          }
	            	            if(o=='xiangqing'){
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../CakeShop/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
