<template>
  <div>
    ...
    >  
     <el-row>
                              <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="客户账号" prop="yonghuzhanghao">
          <el-input v-model="ruleForm.yonghuzhanghao" readonly              placeholder="客户账号" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="客户姓名" prop="yonghuxingming">
          <el-input v-model="ruleForm.yonghuxingming"               placeholder="客户姓名" clearable></el-input>
        </el-form-item>
      </el-col>
                                          <el-col :span="12">
        ...
        <el-form-item   v-if="flag=='yonghu'"  label="地址" prop="dizhi">
          <el-input v-model="ruleForm.dizhi"               placeholder="地址" clearable></el-input>
                                                                                                                                                ...
                                                                                                                                                <el-form-item v-if="flag=='users'" label="客户名" prop="username">
        <el-input v-model="ruleForm.username" 
        placeholder="客户名"></el-input>
      </el-form-item>
      <el-col :span="24">
      <el-form-item>
